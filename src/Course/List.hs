...
lengthGT4 ::
  List a
  -> Bool
lengthGT4 l = lengthCountGTR l 4

lengthCountGTR :: List a -> Int -> Bool
lengthCountGTR _ 0 = True
lengthCountGTR Nil _ = False
lengthCountGTR (_ :. xs) c = lengthCountGTR xs (c-1)
